package chnl_pkg;
	...
	class chnl_driver extends uvm_driver #(chnl_trans);
		...
		function new(string name = "chnl_driver",uvm_component parent = null);
	...
	class chnl_generator extends uvm_component;
		...
		function new(string name = "chnl_generator",uvm_component parent = null);
			super.new(name,parent);
			this.req_mb = new();
			this.rsp_mb = new();
		endfunction
	...
	class chnl_monitor extends uvm_monitor;
		...
		function new(string name = "chnl_monitor",uvm_component parent = null);
			super.new(name,parent);
		endfunction
	...
	class chnl_agent extends uvm_agent;
		...
		function new(string name = "chnl_agent",uvm_component parent = null);
			super.new(name,parent);
		endfunction
