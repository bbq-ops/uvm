...
package chnl_pkg;
    ...
    class chnl_agent();
        ...
        task run();
            repeat(ntrans) this.init.chnl_write(this.gen.get_trans());
            this.init.chnl_idle();
        endtask
    endclass
    ...
    class chnl_root_test;
        ...
        function new(int ntrans = 100,string name = "chnl_root_test");
            foreach(agent[i]) begin
                agent[i] = new($sformatf("chnl_agent%d",i),i,ntrans);
            end
            this.name = name;
    ...
    class chnl_fifo_full extends chnl_root_test;
...
mcdt dut(
   .clk_i(clk)
  ,.rstn_i(rstn)
  ,.ch0_data_i  (chnl0_intf.ch_data  )
  ,.ch0_valid_i (chnl0_intf.ch_valid )
  ,.ch0_ready_o (chnl0_intf.ch_ready )
  ,.ch0_margin_o(chnl0_intf.ch_margin)
  ,.ch1_data_i  (chnl1_intf.ch_data  )
  ,.ch1_valid_i (chnl1_intf.ch_valid )
  ,.ch1_ready_o (chnl1_intf.ch_ready )
  ,.ch1_margin_o(chnl1_intf.ch_margin)
  ,.ch2_data_i  (chnl2_intf.ch_data  )
  ,.ch2_valid_i (chnl2_intf.ch_valid )
  ,.ch2_ready_o (chnl2_intf.ch_ready )
  ,.ch2_margin_o(chnl2_intf.ch_margin)
...
chnl_intf chnl0_intf(.*);
chnl_intf chnl1_intf(.*);
chnl_intf chnl2_intf(.*);

chnl_basic_test basic_test;
chnl_burst_test burst_test;
chnl_fifo_full fifo_full;
...
initial begin
    ...
    basic_test.set_interface(chnl0_intf,chnl1_intf,chnl2_intf);
    burst_test.set_interface(chnl0_intf,chnl1_intf,chnl2_intf);
    fifo_full.set_interface(chnl0_intf,chnl1_intf,chnl2_intf);
