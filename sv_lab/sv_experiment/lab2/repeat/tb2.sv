...
task automatic basic_test();
    ...
    $display("basic_test initialized componentsnents");
    wait(rstn === 1'b1);
...
chnl_initiator chnl0_init(chnl0_intf);

chnl_initiator chnl1_init(chnl1_intf);

chnl_initiator chnl2_init(chnl2_intf);
