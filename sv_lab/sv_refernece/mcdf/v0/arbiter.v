  ...
  if (!rstn_i) begin
    ...
    a2f_pkglen_sel_r <= 3'b111;
         ...
         case ({slv2_req_i,slv1_req_i,slv0_req_i})  
		     ...
		     3'b111: 	begin
							      // Find the slave with highest priority
							      if((slv0_prio_i >= slv1_prio_i) && (slv0_prio_i >= slv2_prio_i))  
										begin 
											id_sel_r <= 2'b00;															//slave0 has highest priority
											a2f_pkglen_sel_r <= slv0_pkglen_i;
										end  
							      else if((slv1_prio_i >= slv0_prio_i) && (slv1_prio_i >= slv2_prio_i))   
										begin
											id_sel_r <= 2'b01;              										//slave1 has highest priority
											a2f_pkglen_sel_r <= slv1_pkglen_i;
										end 
							      else   
										begin
											id_sel_r <= 2'b10; 														//slave2 has highest priority
											a2f_pkglen_sel_r <= slv2_pkglen_i;
										end 
							    end
