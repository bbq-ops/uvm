...
package uvm_config_pkg;
    ...
    class comp2 extends uvm_component;
        ...
        function void build_phase(uvm_phase phase);
            ...
            `uvm_info("GETINT",$sformatf("before config get,var2 = %d",var2),UVM_LOW)
            uvm_config_db#(int)::get(this,"","var2",var2);
            `uvm_info("GETINT",$sformatf("after config get,var2 = %d",var2),UVM_LOW)
            
            uvm_config_db#(config_obj)::get(this,"","cfg",cfg);
            `uvm_info("GETOBJ",$sformatf("after config get,cfg.comp2_var = %d",cfg.comp2_var),UVM_LOW)
    ...
    class comp1 extends uvm_component;
        ...
        function void build_phase(uvm_phase phase);
            ...
            `uvm_info("GETINT",$sformatf("before config get,var1 = %d",var1),UVM_LOW)
            uvm_config_db#(int)::get(this,"","var1",var1);
            `uvm_info("GETINT",$sformatf("after config get,var1 = %d",var1),UVM_LOW)
            
            uvm_config_db#(config_obj)::get(this,"","cfg",cfg);
       	    `uvm_info("GETOBJ",$sformatf("after config get,cfg.comp1_var = %d",cfg.comp1_var),UVM_LOW)
