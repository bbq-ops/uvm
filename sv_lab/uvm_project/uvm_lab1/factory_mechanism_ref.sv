...
package factory_pkg;
  ...
  class trans extends uvm_object;
    ...
    function new(string name = "trans");
      super.new(name);
      `uvm_info("CREATE", $sformatf("trans type [%s] created", this.get_name()), UVM_LOW)
    endfunction
  endclass
  ...
  class object_create extends top;
    ...
    function void build_phase(uvm_phase phase);
      ...
      t2 = trans::type_id::create("t2"); // common method
      `uvm_info("AFTER", $sformatf("t2 final name: %s", t2.get_name()), UVM_LOW)
      void'($cast(t3,f.create_object_by_type(trans::get_type(), "", "t3"))); // factory method
